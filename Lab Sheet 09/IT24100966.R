setwd('/Users/pamithkaluarachchi/SLIIT/Y2S1/PS/Labs/Lab 9/IT24100966')
getwd()
...
#Conclusion:Since p value (0.0005364) is less than 0.05, we can reject H0 at 5% level of significance. Therefore, we can conclude that the true mean baking time is less than 46.S